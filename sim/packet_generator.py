...
def build_l3_packet(proto, dst_ip):
...
def build_ether_frame(proto, dst_ip, src_mac=None, dst_mac=None):
    src_mac = src_mac or random_mac()
    dst_mac = dst_mac or random_mac()
    l3 = build_l3_packet(proto, dst_ip)
...
def main():
    ...
    try:
        for i in range(args.count):
            ...
            frame = build_ether_frame(proto, dst_ip)
